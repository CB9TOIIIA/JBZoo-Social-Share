		...
		<table class="list stripe">
			...
			?>
				<tr>
					...
					<td class="sharecount" style="width:260px;">
              		  <!-- load js -->
                    <div class="result">
                    <?php echo "<div class='yashare-auto-init' data-yashareL10n='ru' data-yashareType='small' data-yashareQuickServices='vkontakte,facebook,odnoklassniki,moimir,gplus' data-yashareLink='http://".$_SERVER['HTTP_HOST']."/item/".$row->alias.".html' data-yashareTheme='counter'></div>"?>
                    </div>
                    </td>
					<td class="type">
